...
public interface NavPersonalInfoContract {

    interface INavPersonalInfoView extends IView {
    }

    interface INavPersonalInfoPresenter extends IPresenter<INavPersonalInfoView> {
