...
public interface RandomPictureContract {

    interface IRandomPictureView extends IView {
    }

    interface IRandomPicturePresenter extends IPresenter<IRandomPictureView> {
